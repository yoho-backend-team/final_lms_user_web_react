      ...
      <Button  
        ...
        startIcon={
          <FileUploadOutlinedIcon 
            sx={{ color: "#5611B1", fontSize:"18px", fontWeight:600,lineHeight:"24px" }} 
          />} 
        sx={{ border: "2px solid #5611B1", borderRadius: "24px", color: "#5611B1", fontSize:"18px", fontWeight:600,lineHeight:"24px" }}
      >
        Notes
      </Button>
        ...
        <DialogContent>
          <Formik
            ...
            onSubmit={(values, { setSubmitting }) => {
              setSubmitting(false);
              const data = { notes : { title : values?.title, description : values?.description, file : values.file }}
              updateClass(data)
              handleClose()
            }}
          >
