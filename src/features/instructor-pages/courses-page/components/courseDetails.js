...
const CourseDetails = () => {
    const Benefits = [
        ...
        {icon: <NoteIcon  color = 'white' fill={"white"} padding="17px 41px 10px 40px" /> , id: "benifit3", title: "Notes", background : "#0F8D0D",shadow: '0px 0px 50px 0px rgba(15, 141, 13, 0.63)'}
    ]
    return(
        <Box sx={{ pr: "60px", overflowY: "auto", maxHeight: "100vh" }}>
            <Box sx={{ display: "flex", flexDirection:"column", pr:"90px" }} >
                <Box sx={{ display:"flex", justifyContent:"space-between", pb:"20px" }} >
                   <Typography sx={{ color : "#4B4B4B", fontSize:"16px", fontWeight:800, lineHeight:"24px"}} >
                     Course Details
                   </Typography>
                   <Typography>
                     <span style={{ color:"#4B4B4B", fontSize:"12px", lineHeight:"14px", fontWeight: 600}} >Purchased on:</span>
                     <span style={{ color:"#000000", fontSize:"12px", lineHeight:"14px", fontWeight: 600}} >23 Jan 2024</span>
                   </Typography>
                </Box>
                <Box sx={{ pb:"27px" }} >
                ...
                <Box sx={{ pb:"12px", display: "flex", gap : "21px" }}>
                    ...
                    <Typography sx={{ display: "inline-flex", gap:"5px", alignItems : "center" }} >
                        ...
                        <span style={{ color : "#000000",fontSize:"12px",fontWeight: 700, lineHeight: '13px'}} >( 4.0 )</span>
                    </Typography>
                </Box>
                <Box sx={{ display: "flex", gap: "20px", alignItems : "center", pb: "21px" }} >
                    <Typography sx={{ color : "#000000", fontSize: "14px", fontWeight: 700, lineHeight: "10px" }} >
                       By Rajalakshmi Institute
                    </Typography>
                    <Typography sx={{ display: "inline-flex", alignItems : 'center', gap: "6px" }} >
                        <UpdateIcon sx={{ color : "black"}} />
                        <span style={{ color : "#000000", fontSize: "14px", fontWeight:600, lineHeight:"10px"}} >12hrs</span>
                    </Typography>
                </Box>
                 <Box>
                 ...
                 <Box >
                    <Box sx={{ pt:"40px", pb:"20px" }} >
                       <Typography sx={{ color : "#4B4B4B", fontSize: "16px", fontWeight: 600, lineHeight : "14px" }} >Benefits</Typography>
                    </Box>
                    <Box sx={{ display: "flex", gap: "40px", flexWrap: "wrap" }} >
                       {Benefits?.map((item)=>(
                        <Box key={item.id} sx={{ backgroundColor : item.background, boxShadow: item.shadow, display:"flex", flexDirection: "column", justifyContent: "center", alignItems: "center", borderRadius: '11px'}} >
                            <Typography sx={{ padding:"17px 41px 10px 40px" }} >
                             {item.icon}
                            </Typography>
                             <Typography sx={{ color : "#FFFFFF", fontSize: "14px", fontWeight: 600, lineHeight: "23px", px: "10px", pb: "11px" }} >{item.title}</Typography>
                        </Box>
                       ))}
                    </Box>
                 </Box>
