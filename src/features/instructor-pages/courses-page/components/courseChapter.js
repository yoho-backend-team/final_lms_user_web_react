...
const chapters = [
  ...
  { title: 'Frame Work and Styling', classes: 12, background : "linear-gradient(118deg, #CF75FF 1.82%, #670BC3 97.62%)", color : '#DEAEFF' },
  { title: 'Prototype and Functionalities', classes: 12, background: "linear-gradient(118deg, #FADB39 1.75%, #F90 100%)", color : "#A58C06" },
  { title: 'Foundation of Python & SQL Basics', classes: 12 ,background: 'linear-gradient(120deg, #0068FF 2.28%, #141BC4 100%)',color : "#84B6FF"},
];
...
const CourseChapters = () => {
  return (
    <Box sx={{ pl : "91px", pr: "50px", height: "80vh", overflowY : "auto"}} >
      ...
      <Typography variant="h6" component="div" sx={{ color : "#4B4B4B", fontSize: "16px", fontWeight :800, lineHeight : "24px" }}>
