import CourseModuleCard from "../course-view-page/components/Notes&Material/courseModuelCard";
...
const BatchClassListViewPage = ({classes,openCourseView,closeCourseView}) => {
...
export default BatchClassListViewPage;
