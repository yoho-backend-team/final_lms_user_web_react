...
import { Box, Button, TextField, Typography, FormControl, FormLabel, Paper, Divider } from '@mui/material';
      ...
      <Box sx={{ flexGrow: 1, maxWidth: '50%' }}>
        ...
        <form onSubmit={formik.handleSubmit} style={{ display: 'flex', gap: '20px', flexDirection: 'column' }}>
          ...
          <FormControl fullWidth sx={{ mb: 2, maxWidth: '460px' }}>
            ...
            <Paper className={classes.root} variant="outlined" sx={{display:"flex",justifyContent:"center",alignItems:"center"}} component="label">
              <input
                type="file"
                accept=".pdf,.doc,.docx"
