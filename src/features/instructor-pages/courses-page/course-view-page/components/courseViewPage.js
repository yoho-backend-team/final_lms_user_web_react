...
//       {/* Header Section */}
//       <Box sx={{ pl: "40px", pt: "40px", flexShrink: 0 }}>
...
//             />
//             <Typography sx={{ color: "#000", fontSize: "20px", fontWeight: 800 }}>
//               {getTabContent()}
//             </Typography>
//           </Box>
//           <Box>
...
//                 sx={{
//                   "&.MuiTabs-root:not(.MuiTabs-vertical)": { borderBottom: 0 },
//                   "& .MuiTabs-indicator": { backgroundColor: "#5611B1" },
//                   "& .MuiTab-root": { color: "#000000" },
//                   "& .Mui-selected": { color: "#5611B1" },
//                 }}
//               >
//                 <Tab value={"1"} label={"About"} sx={{ fontSize: "16px", fontWeight: 500 }} />
//                 <Tab value={"2"} label={"Notes & Materials"} sx={{ fontSize: "16px", fontWeight: 500 }} />
//                 <Tab value={"3"} label={"Batches"} sx={{ fontSize: "16px", fontWeight: 500 }} />
//               </Tabs>
//             </Box>
//           </Box>
...
//         {currentTab === "2" && !courseView && <StudyMaterialPage course={Course} getCourseDetails={getCourseDetails} />}
...
//           <BatchClassListViewPage
//             classes={selectedBatch?.classes}
//             openCourseView={openCourseView}
//             closeCourseView={closeCourseView}
//           />
//         )}
...
const CourseViewPage = ({ Course, handleBack, getCourseDetails }) => {
  ...
  const closeCourseView = () => {
    ...
    setSelectedClass(null);
    setSelectedClassId(null);
    navigate('/courses');  // Redirect to the courses page or desired section
  };
    ...
    <Box sx={{ height: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <Box sx={{ pl: "40px", pt: "40px", flexShrink: 0 }}>
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <Box sx={{ display: "flex", alignItems: "center", gap: "20px" }}>
            <IconButton onClick={closeCourseView}>
              <ArrowBack sx={{ color: "black" }} />
            </IconButton>
            <Typography sx={{ color: "#000", fontSize: "20px", fontWeight: 800 }}>
              {courseView ? "Class Details" : "Course"}
            </Typography>
          </Box>
          {courseView && (
            <Button
      ...
      <Box sx={{ flex: 1, overflowY: "auto", padding: "20px" }}>
        {!courseView ? (
          ...
          <SingleCourseView selectedClass={selectedClass} selectedClassId={selectedClassId} />
        )}
      </Box>
    </Box>
  );
