...
import { Box, TextField, MenuItem, Button, Typography, Grid, InputLabel, FormControl, FormHelperText, Select } from '@mui/material';
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
       ...
       const data = { institute : instructor?.institute_id?._id, branch : instructor?.branch_id?._id, query : values?.problem, description : values?.description, user : instructor?._id } 
            ...
            >
              ...
              >
               <FormControl
                 ...
                 fullWidth
               >
                 <InputLabel className={classes.label} id="demo-simple-select-label">Select your Problem</InputLabel>
                 <Select
              ...
              <Box sx={{ display: "flex", flexDirection: "column", gap: "10px" }} >
                  <FormControl
                    ...
                    fullWidth
                  >
                    <InputLabel className={classes.label} shrink>Description</InputLabel>
                    <TextField
                      multiline
                      rows={7}
                      name="description"
          ...
          <Grid item xs={4}>
            ...
            >
              ...
              <Box sx={{ display: 'flex', justifyContent: 'flex-end', gap: 2 }}>
                ...
                <Button type="submit" onClick={formik.handleSubmit} variant="contained" className={classes.conformButton} sx={theme.custom.buttonStyles.button1}>
                  Confirm Ticket
                </Button>
              </Box>
            </Grid>
