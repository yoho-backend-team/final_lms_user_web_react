...
const TicketCard = ({ ticketNumber, query, description, status, date, id,handleTicketViewOpen,_id }) => {
  ...
  return (
    ...
    >
        <Box sx={{display:"flex",justifyContent:"space-between"}}>
            <Box>
               <Typography sx={{color:"#495057",fontSize:"16px",fontWeight:700,lineHeight:"24px"}} >{ ticketNumber ? ticketNumber : _id }</Typography>
            </Box>
        ...
        <Box>
          <Typography sx={{color:"#495057",fontWeight:"700",lineHeight:"24px",fontSize:"14px"}} >{query}</Typography>
        </Box>

        <Box sx={{pt:"13px",display:"flex",justifyContent:"flex-start",width:"296px",maxHeight:"60px"}} >
          <Typography sx={{color:"#6C757D",fontSize:"16px",lineHeight:"22px",fontWeight:"500",height:"66px",maxHeight:"60px",overflow:"auto"}} >
          {description}
          </Typography>
        </Box>
        ...
        <Box sx={{display:"flex",justifyContent:"space-between",pt:"21px"}} >
           <Box sx={{display:"flex",gap:"4px",alignItems:"center"}}>
             ...
             <Typography sx={{fontSize:"15px",fontWeight:"400",lineHeight:"14px",color:"#020202"}}>{id}</Typography>
           </Box>
           <Box>
