import { Avatar, Box, IconButton, Input, Tab, Tabs, Typography, InputAdornment, Badge } from "@mui/material";
                                    ...
                                    <Box sx={{ display: 'flex', flexDirection: "row", justifyContent: 'space-between' }}>
                                        ...
                                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: "4px" }}>
                                            ...
                                            {notifi.status === "unread" && (
                                                <Box sx={{ width: "6.5px", height: "6.5px", borderRadius: "50%", backgroundColor: "#006AD4" }} />
                                            )}
                                        </Box>
                                    </Box>
                                    <Box>
