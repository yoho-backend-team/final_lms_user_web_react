  ...
  return (
    ...
    >
      {!selectedNotification ? (
        ...
        >
         <NotificationsActiveIcon sx={{ color: theme.palette.primary.main, fontSize: 60 }} />
        ...
        >
          ...
          >
            ...
            <Typography
              variant="h5"
              fontWeight={700}
              sx={{ color: "#1A1A1A",fontSize: "1.2rem", letterSpacing: 0.5 }}
            >
              Notification
            </Typography>
          </Box>
