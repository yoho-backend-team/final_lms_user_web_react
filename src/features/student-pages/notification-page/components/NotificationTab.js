...
const NotificationTab = ({ tabValue, handleTabChange, notifications, handleNotificationChange, selectedNotification }) => {
  ...
  // Filter notifications based on tabValue and searchQuery
