      ...
      <Grid container spacing={2} sx={{ p: 2 }}>
        <Grid item xs={matchesXS ? 12 : 3}>
          ...
          <Grid
            container
            spacing={2}
            sx={{ paddingTop: 2, paddingRight: 10, paddingBottom: 2 }}
          >
            <Grid
              item
              xs={12}
        ...
        <Grid item xs={matchesXS ? 12 : 9}>
          ...
          <Grid item xs={12} sx={{ paddingTop: 3 }}>
            ...
            <div
              className="recorded-class-scroll-container"
              id="recorded-class-scroll-container"
              style={{
                display: "flex",
                overflowX: "auto",
                gap: "10px",
              ...
              {[html1, html2, html3, html4, html5].map((image, index) => (
                <div key={index} style={{ flex: "0 0 auto" }}>
                  <img
                    src={image}
                    alt={`html${index + 1}`}
                    style={{ width: "214px", height: "114px" }}
                  />
                </div>
              ))}
            </div>
          ...
          <Grid item xs={12} sx={{ paddingTop: 2 }}>
            ...
            <div
              ...
              id="study-material-scroll-container"
            >
              <div
                style={{
                  display: "flex",
