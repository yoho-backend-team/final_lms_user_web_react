...
const modules = [
  {
    id: 1,
    title: "Foundation of Python& SQl Basic ...",
    progress: "97%",
    notes: 2,
    videos: 32,
    style: {
  ...
  {
    id: 3,
    title: "Prototype Functionalities ...",
    progress: "0%",
    notes: 0,
    videos: 0,
    style: {
...
const CourseAndNotesStudentPage = ({ openCourseView, closeCourseView }) => {
