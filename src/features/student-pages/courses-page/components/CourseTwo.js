    ...
    return (
        <StyledPaper elevation={3}>
            ...
            <Grid container spacing={2} mt={4}>
                {[stu3, stu1, stu2].map((image, index) => (
                                ...
                                <Demo variant="outlined">
                                    <Grid container alignItems="center" spacing={1}>
                                        ...
                                        <Grid item xs={10}>
                                            ...
                                            <Typography variant='body1'>JavaScript Development <FileDownloadOutlinedIcon style={{ marginBottom: "-5px" }} /></Typography>
                                        </Grid>
                                    </Grid>
                                </Demo>
                            </Grid>
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                            <Demo variant="outlined">
                                <Grid container alignItems="center" spacing={1}>
                                    ...
                                    <Grid item xs={10}>
                                        <Typography variant='h4' gutterBottom>Java Notes</Typography>
                                        <Typography variant='body1'>JavaScript Latest Version... <FileDownloadOutlinedIcon style={{ marginBottom: "-5px" }} /></Typography>
                                    </Grid>
                                </Grid>
                            </Demo>
                        </Grid>
