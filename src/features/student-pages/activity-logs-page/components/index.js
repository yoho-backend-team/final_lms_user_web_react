...
import { useDispatch, useSelector } from 'react-redux';
import NoDataImage from '../../../../assets/no-data.jpg';
import BackgroundImage from 'assets/images/background/student.png'; // Import the background image
    ...
    >
      <Box
        sx={{
          ...
          width: '100vw',
          height: '120vh',
          backgroundImage: `url(${BackgroundImage})`, // Properly loaded background image
          backgroundSize: 'cover',
          backgroundPosition: 'center',
        }}
      >
        ...
        <Box
          sx={{
            backgroundColor: '#FFFFFF', // Set the same background color for the content section
          }}
        >
          <Paper sx={{ boxShadow: 'none' }}>
            <Box sx={{ maxHeight: 500, overflow: 'auto', padding: 2 }}>
