...
export default function OnlineLiveClasses() {
  const { id } = useParams();
              ...
              <Grid item xs={12} md={6}>
                ...
                <Box mt={3}>
                  <Typography variant="h3">
                    Basics of Python Chapter 3, Framework & Styling
                  </Typography>
                </Box>
                <Box mt={4}>
                  <Typography variant="body1">
                    User experience (UX) is the overall experience a user has
                    when interacting with a product or service. UX design is the
                    process of creating products that provide meaningful
                ...
                <Box mt={4}>
                  <Card sx={{ backgroundColor: "#beeef7" }}>
                    <CardContent>
                      ...
                      >
                        <Typography variant="h4" sx={{ color: "#79a7d9" }}>
                          13 Feb 2024
                        </Typography>
                        <Typography variant="h4" sx={{ color: "#79a7d9" }}>
                          10:30 AM
                ...
                <Box mt={4}>
                  <Grid container spacing={2}>
                    ...
                    >
                      ...
                      <Typography variant="body1">
                        <ErrorOutlineIcon sx={{ marginBottom: "-6px" }} />
                        If there are any issues with attendance, please raise a
                        ticket.
                      </Typography>
                    </Grid>
                  </Grid>
