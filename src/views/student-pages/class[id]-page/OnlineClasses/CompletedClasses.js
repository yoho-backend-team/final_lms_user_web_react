    ...
    <StudentClassLayout>
      ...
      <Box>
        ...
        >
          <Grid>
            <ArrowBackIcon
              sx={{ marginBottom: "20px", zIndex: "1000", cursor: "pointer" }}
            ...
            >
              User experience (UX) is the overall experience a user has when
              interacting with a product or service. UX design is the process of
              creating products that provide meaningful experiences for users.
            </Typography>
          </Grid>
          <Box
            sx={{
          ...
          >
            ...
            <Box sx={{ display: "flex" }}>
              ...
              <Box
                sx={{ marginRight: "10px", marginLeft: "10px", gap: "40px" }}
              >
                <Typography
                  variant="h1"
                  sx={{
            ...
            <Box sx={{ display: "flex", flexDirection: "column" }}>
              ...
              <AvatarGroup max={4} total={24}>
                ...
                <Avatar
                  ...
                  src="/static/images/avatar/4.png"
                />
                <Avatar
                  alt="Trevor Henderson"
                ...
                <Avatar
                  alt="Trevor Henderson"
                  src="/static/images/avatar/6.png"
                />
              </AvatarGroup>
