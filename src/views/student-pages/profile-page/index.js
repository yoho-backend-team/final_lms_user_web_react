...
const ProfilePage = () => {
  ...
  const infoItems = [
    ...
    { icon: <HomeIcon />, label: 'Address', value: `${personalInfo.address1}, ${personalInfo.address2}` },   
  ];  
  ...
  const Instituteinfo = [
    ...
    { icon: <FaIdCard style={{fontSize:'23px'}}/>, label: 'Student ID', value: personalInfo?.userDetail?.id },    
  ];

  //dummy
  const AcademicInfo = [
    { icon: <img src={percentage} alt="percentage" />, label: 'Total Percentage', value: '75%' },
    { icon: <img src={asignedicon} alt="Assigned icon" />,label: 'Projects Assigned', value: '2' },
    { icon: <img src={pendingcourse} alt="pendingcourse" />, label: 'Pending Course', value: '4' },    
  ];
  ...
  return (
    <Box sx={{ p: 5 }}>
     <Grid item xs={12} sm={6} style={{ textAlign: 'left' }}>
        ...
        >
          <KeyboardBackspaceIcon style={{ marginRight: '5px' }} /> Back to Dashboard
        </Typography>
    
    </Grid>
      <Grid container xs={12} spacing={2} sx={{p: 3, gap:{md:"20px",xl:"72px"}}}>     
        <Grid item xs={7.3} md={7.3}>        
          <Card item sx={{backgroundColor: 'white',overflow: 'auto', padding: '20px',maxHeight: '100%', maxWidth: '100%' }}>
              ...
              {editing && (
                <>
                 ...
                 <label htmlFor="avatar-upload">
                  ...
                  >
                   <FileUploadOutlinedIcon style={{ color: 'white' ,  fontSize: '16px', }}/> Upload
                  </Button>
                </label>
                
                </>
              )}
              <div style={{ display: 'flex', position: 'absolute', top: 140, right: 30  }}>
              {editing ? (
        <>
          <IconButton
            aria-label="cancel"
          ...
          >
            <CancelIcon style={{ color: 'red', marginRight: '5px' }} /> Cancel
          </IconButton>
          <Button
            variant="contained"
        ...
        <Grid item xs={4} md={4}>
          ...
          <Box sx={{ p: 2, display: 'flex', alignItems: 'center' }}>
              <div style={{ flex: 1 }}>
                <Typography variant="body1" sx={{ mb: 2, color: '#000000', fontFamily: 'Nunito Sans', fontSize: '20px', fontWeight: 700, lineHeight: '26px', textAlign: 'left' }}>
                  Current Chapter / Topic
                </Typography>
                <Typography variant="body2" style={{ color: '#403B3B' ,fontFamily: 'Poppins', fontSize: '14px', fontWeight: 400, lineHeight: '21px', textAlign: 'left' }}>
                  Chapter 2
                </Typography>
              </div>
